...
class SiteSeeder extends Seeder
{
    ...
    public function run(): void
    {
            ...
            $city_id = [2 ,1,6,3,5,7];
            $city_en = ['Damascus', 'Aleppo', 'Damascus','Damascus', 'Aleppo', 'Damascus'];
            $city_ar = [' دمشق', 'حلب','دمشق',' دمشق', 'حلب','دمشق'];
            $photo_cover = [
            ...
            $title_en = ['Mount Qassioun', 'Aleppo Cetadel' ,'Palmyra','Mount Qassioun', 'Aleppo Cetadel' ,'Palmyra'];
            $title_ar = ['جبل قاسيون', 'قلعة حلب' ,'مملكة تدمر','جبل قاسيون', 'قلعة حلب' ,'مملكة تدمر'];
            $Site_rating = [4,4,3,5,4,2];
            $description_en = [
            ...
            $email = ['Busra@gmail.com', 'Aleppo_Cetadel@gmail.com', 'Palmyra@gmail.com','Busra@gmail.com', 'Aleppo_Cetadel@gmail.com', 'Palmyra@gmail.com'];
            $working_time = ['24/24', '16/24', '24/24','24/24', '16/24', '24/24'];
            $type = ['Natural', 'Natural', 'Natural','Archeological','Archeological','Archeological'];
